    ...
    <section
      ...
      <div className="relative flex flex-col md:flex-row-reverse items-center md:items-start lg:justify-stretch mt-32 lg:mb-16 md:mb-8">
        <div className="relative w-full h-full mb-10 lg:w-3/4">
          ...
          <div className="relative mx-12 md:mx-0 bg-linear-to-t from-[#242424] z-40 md:absolute md:-top-24 md:-left-8 md:w-[350px] md:h-[560px] lg:w-[420px] lg:left-3">
            <Image
              src="/profile.png"
              width={600}
              height={1000}
          ...
          <div className="z-50 absolute bottom-0 -right-24 md:-top-8 lg:top-72 lg:-left-[54px]">
            <PatternCircle />
          </div>
        </div>
        <div className="z-50 flex flex-col items-center md:items-start gap-6 md:gap-8">
          <h1 className="text-[40px] sm:text-7xl lg:text-[88px] sm:text-pretty text-center md:text-left text-white mb-2">
